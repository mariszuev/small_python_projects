...
def getMatch(birthdays):
    ...
    if len(birthdays) == len(set(birthdays)):
        return None # All the birthdays are unique, so return None.
...
that two of them have matching birthdays is surprisingle large.
...
if match != None:
    ...
    print('multiple pople have a birthday on', dateText)
else:
